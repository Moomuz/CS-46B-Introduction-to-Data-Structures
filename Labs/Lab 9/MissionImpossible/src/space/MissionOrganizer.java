...
public class MissionOrganizer implements Iterable<Mission>
{
	...
	private ArrayList<Mission> collectToList()
	{
	...
	private class MissionIterator implements Iterator<Mission>
	{
		...
		MissionIterator()
		{
			allMissions = collectToList();
		}
		
		public boolean hasNext()
		{
			return index < allMissions.size();
		}
	...
	private final static Mission[]		TEST_MISSIONS =
	{
        ...
        new Mission("Neverland", 9E10f),
        new Mission("Narnia", 8E10f),
        new Mission("Earth C-137", 12E12f),
        new Mission("Blackhole", 16E12f)
	};
