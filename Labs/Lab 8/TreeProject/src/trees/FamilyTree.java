...
public class FamilyTree 
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		else
		{
			...
			{
				throw new TreeException("Parent node not found. Check data file.");
			}
		}
		...
		{
			TreeNode n = new TreeNode(childName);
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("No node with " + name1 + " was found.");
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("No node with " + name2 + " was found.");
